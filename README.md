...
| `🗂️Data/`↳ `📄Hospital_data.xlsx` | Single workbook containing: Power Query cleaning steps, Data Model, Pivot Report sheet, Dashboard sheet, and 3 supporting detail sheets |
